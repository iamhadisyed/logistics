...
class ThemesFilter
{
    ...
    public function getList($columns = '*', $debug = false)
    {
        ...
        return Themes::getThemesListFromSql($sql);
    }
    ...
    public function getCount($soft = true, $debug = false)
    {
        if ($soft) {
            ...
            $where = $this->getWhere();
            $sql = "SELECT COUNT(t.id) AS total FROM themes t $join $where";
            if ($debug) {
                echo $sql;
                die();
            }
        }
        return Themes::getTotalNumberOfThemesFromSql($sql);
    }
    ...
    public function delete($debug = false)
    {
        ...
        $where = $this->getWhere();
        $sql = "DELETE FROM themes  $join $where";
        if ($debug) {
            echo $sql;
            die();
        }
        return Themes::deleteThemesFromSql($sql);
    }
