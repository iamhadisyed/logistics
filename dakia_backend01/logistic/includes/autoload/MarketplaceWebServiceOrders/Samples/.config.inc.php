<?php
  ...
  //  define('AWS_SECRET_ACCESS_KEY', '<Your Secret Key>');
    define('AWS_ACCESS_KEY_ID', $_SESSION['detail']['AWS_ACCESS_KEY_ID']);
    define('AWS_SECRET_ACCESS_KEY', $_SESSION['detail']['AWS_SECRET_ACCESS_KEY']);
   /************************************************************************
    * REQUIRED
    *
   ...
   // define('APPLICATION_VERSION', '<Your Application Version or Build Number>');
    define('APPLICATION_NAME', 'My Store');
    ...
    ***********************************************************************/
    ...
    define ('MERCHANT_ID',$_SESSION['detail']['MERCHANT_ID']);	
    define ('MARKETPLACE_ID', $_SESSION['detail']['MARKETPLACE_ID']);
