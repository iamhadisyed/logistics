...
<?xml version="1.0" encoding="UTF-8"?>
	<AmazonEnvelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="amzn-envelope.xsd">
		...
		<Message>
			...
			<OrderFulfillment>
				<AmazonOrderID>205-9484514-3723515</AmazonOrderID>
				<MerchantFulfillmentID>1</MerchantFulfillmentID>
				<FulfillmentDate>2014-09-15T07:50:58Z</FulfillmentDate>
				<FulfillmentData>
				...
				<Item>
					<AmazonOrderItemCode>09162444541651</AmazonOrderItemCode>
					<Quantity>1</Quantity>
				</Item>
			</OrderFulfillment>
		</Message>
  ...
  function invokeSubmitFeed(MarketplaceWebService_Interface $service, $request) 
  {
      try {
              $response = $service->submitFeed($request);
                ...
                echo($response->getResponseHeaderMetadata());
