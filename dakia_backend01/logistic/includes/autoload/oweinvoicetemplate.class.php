...
class oweinvoicetemplate extends TCPDF {
...
//        $this->MultiCell(35, 8, '1', 1, 'L', 0, 0, 160, 59, '', '', '', '', '8','M', true);
        ...
        $this->SetTextColor(255, 255, 255);
        $this->MultiCell(20, 7, 'Order Ref', 0, 'C', 1, 0, 10, 68, '', '', '', '', '8','M', true);
        if($this->checks['check_box_date'] == 1) {
            $this->MultiCell(23, 7, 'Label Created', 0, 'C', 1, 0, 30, 68, '', '', '', '', '8','M', true);
        }
        if($this->checks['check_box_reference'] == 1) {
            $this->MultiCell(23, 7, 'Reference', 0, 'C', 1, 0, 53, 68, '', '', '', '', '8','M', true);
        }
        if($this->checks['check_box_destination'] == 1) {
            $this->MultiCell(27, 7, 'Destination', 0, 'C', 1, 0, 76, 68, '', '', '', '', '8','M', true);
        }
        if($this->checks['check_box_service'] == 1) {
            $this->MultiCell(25, 7, 'Service', 0, 'C', 1, 0, 103, 68, '', '', '', '', '8','M', true);
        }
        $this->MultiCell(20, 7, 'Weight(KG)', 0, 'C', 1, 0, 128, 68, '', '', '', '', '8','M', true);
        $this->MultiCell(10, 7, 'Pcs', 0, 'C', 1, 0, 145, 68, '', '', '', '', '8','M', true);
        $this->MultiCell(20, 7, 'Basic Chrg', 0, 'L', 1, 0, 155, 68, '', '', '', '', '8','M', true);
        $this->MultiCell(20, 7, 'Add. Chrg', 0, 'L', 1, 0, 170, 68, '', '', '', '', '8','M', true);
        $this->MultiCell(15, 7, 'Total', 0, 'L', 1, 0, 185, 68, '', '', '', '', '8','M', true);
