 ...
 */
// echo SETTING_DIR_REMOTE.'includes/3rdparty/barcodegen/class/BCGArgumentException.php';

include_once(SETTING_DIR_REMOTE.'includes/3rdparty/barcodegen/class/BCGArgumentException.php');
include_once(SETTING_DIR_REMOTE.'includes/3rdparty/barcodegen/class/BCGFont.php');
include_once(SETTING_DIR_REMOTE.'includes/3rdparty/barcodegen/class/BCGColor.php');
