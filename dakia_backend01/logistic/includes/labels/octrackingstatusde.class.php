 ...
 */
class OcTrackingStatusDe {
    
    public function __construct() {
        
    }
    
    public static $oc_status_code_de = array(
    ...
    public static $consignment_status_code_de = array(
        ...
        "ERROR" => Consignment::STATUS_RETURNED,
        "DELIVERY_ATTEMPT" => Consignment::STATUS_INTRANSIT,
        "DELIVERY_EXCEPTION" => Consignment::STATUS_RETURNED
    );

    public static $oneworld_oc_de = array(
        "MANIFEST" =>  144,
    ...
    public static function getOweStatusCode($ocStatusDe){
        $ocTrackingStatusDe = self::$oneworld_oc_de;
        return isset($ocTrackingStatusDe[$ocStatusDe]) ? $ocTrackingStatusDe[$ocStatusDe] : 0;
    }
    public static function getConsignmentStatus($ocStatusDe){
        $consignmentStatusCodesDe = Tracking::$oneworld_consignment_code_mapping;
        return isset($consignmentStatusCodesDe[$ocStatusDe]) ? $consignmentStatusCodesDe[$ocStatusDe] : 0;
    }
}
