 ...
 */
class OcTrackingStatusCa {
    
    public function __construct() {
        
    }
    
    public static $oc_status_code_ca = array(
    ...
    public static $consignment_status_code_ca = array(
    ...
    public static $oneworld_oc_ca = array(
        "MANIFEST" =>  144,
    ...
    public static function getOweStatusCode($ocStatusCa){
        $ocTrackingStatusCa = self::$oneworld_oc_ca;
        return isset($ocTrackingStatusCa[$ocStatusCa]) ? $ocTrackingStatusCa[$ocStatusCa] : 0;
    }
    public static function getConsignmentStatus($ocStatusCa){
        $consignmentStatusCodesCa = Tracking::$oneworld_consignment_code_mapping;
        return isset($consignmentStatusCodesCa[$ocStatusCa]) ? $consignmentStatusCodesCa[$ocStatusCa] : 0;
    }
}
