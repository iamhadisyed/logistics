 ...
 */
class OweToOcTrackingStatus {
    
    public function __construct() {
        
    }
    
    public static $owetooc_status_code = array(
        "X1"  =>  "Processed at UKP",
...
//need to map again oneworld status 
    public static $oneworld_owetooc = array(
        "X1"  =>  148,
        "X2"  =>  137,
        "X3"  =>  137,
        "81"  =>  137,
    ...
    public static function getOweStatusCode($owetoocStatus){
        $owetoocTrackingStatus = self::$oneworld_owetooc;
        return isset($owetoocTrackingStatus[$owetoocStatus]) ? $owetoocTrackingStatus[$owetoocStatus] : 0;        
    }
    public static function getConsignmentStatus($owetoocStatus){
        $consignmentStatusCodes = Tracking::$oneworld_consignment_code_mapping;
        return isset($consignmentStatusCodes[$owetoocStatus]) ? $consignmentStatusCodes[$owetoocStatus] : 0;
    }
}
