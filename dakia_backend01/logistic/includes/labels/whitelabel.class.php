...
class WhiteLabel implements CarrierService {
...
*/
     ...
     /*   $serviceRangeMappingFilter = new ServiceRangeMappingFilter();
        ...
        $this->pdf->Output("../_assets/pdf/" . date('Y_m_d') . '/' . $consignment->getId() . "_overlabel.pdf", "F");
        $output['STATUS'] = 'SUCCESS';
        $output['LABEL'] = date('Y_m_d') . '/' . $consignment->getId() . "_overlabel.pdf";
    ...
    private function addWayBill(Consignment $consignment, $parcel_idx, $licence_plate) {
      ...
      //  $logo =    User::getUserCompanyImages(false,$consignment->getUserId());
       ...
       // if($this->serviceValues->getCode() == "STOWESTND"){
         //   $logo =    SETTING_URL.'images/ship2world.png';
        //} else {
            $logo =    User::getUserCompanyImages(false,$consignment->getUserId());
        //}
...
/*
        ...
        $this->pdf->Text(5, 53, $this->userAccount->getUserAccount());
*/
        $this->pdf->Text(50, 53, "Weight: ". number_format($consignment->getWeight(),2));
