...
class RoyalMailFtpCodes {

    public function __construct() {        
    }
    
    
    public static $StatusCodes = array('EVAIE' =>array ( "EVAIE","Pre-Advice","Pre-advice Item Passed - Received with errors","We're expecting it","The sender has let us know this item will be with us soon."),
