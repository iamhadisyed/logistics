...
class AsendiaPronto implements CarrierService {
    ...
    public function label($consignment, $labelType = 'pdf', $size = '') {
        ...
        if($this->serviceValues->getCode() == "STASEPRON" && trim(@$this->constants['ASENDIAUK_PASSWORD']) == ''){
            $output['STATUS'] = 'ERROR';
        ...
        if (trim(@$this->constants['INTEGRATION_TYPE']) == 'API') {
            if ($this->serviceValues->getCode() == "STASEPRON") {
         ...
         $requestArray = array (
                        ...
                        array (
                          ...
                          array (
                            ...
                            'CountryRegistrationNumber' => NULL,
                            'GSTCollected ' => NULL,
                          ),
                        ),
                      );
