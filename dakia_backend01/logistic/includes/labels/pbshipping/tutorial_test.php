...
try {
	...
	//$opts = getopt("h", array("key::u0aMpIEfSvGPqybz0XG22I1ygQkV2hEz", "secret::cXty4GzIYApnkXZb", "devid::", "merchant::"));
	/*
	...
	*/
	...
	$dev_id = "48093784";
	$api_key = "2xFg3xcl7xorymr9C2FAwx2WwiMkKcEA";
	$api_secret = "O0CWAzpe3RWuWKeF";
	...
	$shipment = new PBShippingShipment(
			array(
	...
	echo "Managing merchant (individual account mode) ...";
	...
	$shipment["shipmentOptions"] = array(
		array("name" => "SHIPPER_ID", "value" => "9021678263"),
		array("name" => "ADD_TO_MANIFEST", "value" => true)
	);
    ...
    echo $shipment->createAndPurchase($auth_obj, $shipment_orig_tx_id, true);
