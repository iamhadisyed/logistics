 ...
 */
class OcTrackingStatusUS {
    
    public function __construct() {
        
    }
    
    public static $oc_status_code_us = array(
    ...
    public static $consignment_status_code_us = array(
    ...
    public static $oneworld_oc_us = array(
        "MANIFEST" =>  144,
    ...
    public static function getOweStatusCode($ocStatusUs){
        $ocTrackingStatusUs = self::$oneworld_oc_us;
        return isset($ocTrackingStatusUs[$ocStatusUs]) ? $ocTrackingStatusUs[$ocStatusUs] : 0;
    }
    public static function getConsignmentStatus($ocStatusUs){
        $consignmentStatusCodesUs = Tracking::$oneworld_consignment_code_mapping;
        return isset($consignmentStatusCodesUs[$ocStatusUs]) ? $consignmentStatusCodesUs[$ocStatusUs] : 0;
    }
}
