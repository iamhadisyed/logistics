...
define("SETTING_URL_NO_HTTP",   "logistics.whooffer.com/");
// define the website
define("COMMON_SITE", "gl");
define("SETTING_URL",   "http://logistics.whooffer.com/");
define("SETTING_MAIN_URL",   "http://logistics.whooffer.com/optimization/");
define("SETTING_MAIN_ASSETS",   "http://logistics.whooffer.com/optimization/_assets/");
define("SETTING_MAIN_URL_ACCOUNT",   "http://logistics.whooffer.com/optimization/");

define("SETTING_DIR_ASSETS",  "_assets/");
...
define("PAYPAL_EMAIL_ADDRESS" , 'itsupport@logistics.com');
...
define("SETTING_DB_USER",     "whooffe2_logistics3");
define("SETTING_DB_PASSWORD", "!,.mPb{rg(O3");
define("SETTING_DB_DATABASE", "whooffe2_logistics");
