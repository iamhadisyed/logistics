...
class ProductsFilter
{
    ...
    public function getCount($soft = true, $debug = false)
    {
        ...
        return Products::getTotalNumberOfProductsFromSql($sql);
    }
    ...
    public function delete($debug = false)
    {
        ...
        $where = $this->getWhere();
        $sql = "DELETE FROM products  $join $where";
        if ($debug) {
            echo $sql;
            die();
        }
        return Products::deleteProductsFromSql($sql);
    }
    ...
    public function update($debug = false){
        ...
        return Products::updateProductsFromSql($sql);
    }
