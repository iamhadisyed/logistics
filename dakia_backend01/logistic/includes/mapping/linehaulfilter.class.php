...
class LinehaulFilter
{
    ...
    public function getList($columns = '*', $debug = false)
    {
        ...
        return Linehaul::getLinehaulListFromSql($sql);
    }
    ...
    public function getCount($soft = true, $debug = false)
    {
        if ($soft) {
            ...
            $where = $this->getWhere();
            $sql = "SELECT COUNT(l.id) AS total FROM linehaul l $join $where";
            if ($debug) {
                echo $sql;
                die();
            }
        }
        return Linehaul::getTotalNumberOfLinehaulFromSql($sql);
    }
    ...
    public function delete($debug = false)
    {
        ...
        $where = $this->getWhere();
        $sql = "DELETE FROM linehaul  $join $where";
        if ($debug) {
            echo $sql;
            die();
        }
        return Linehaul::deleteLinehaulFromSql($sql);
    }

    public function update($debug = false){
        $where = $this->getWhere();
        $set = $this->getSet();
        $sql = "UPDATE linehaul $set $where";
        if ($debug) {
            echo $sql;
            die();
        }
        return Linehaul::updateLinehaulFromSql($sql);
    }
