...
class RemoteareasGroupsLog extends DbAccess3 {
    ...
    public function __construct($mixedCreator = null) {
        ...
        //
        parent::__construct("remoteareas_groups_log", 'id', $fieldList, $mixedCreator);
    }
     ...
     * @param string $sql
     */
    public static function getRemoteareasGroupsLogListFromSql($sql) {
     ...
     * @param string $sql
     */
    public static function getRemoteareasGroupsLogCountFromSql($sql) {
