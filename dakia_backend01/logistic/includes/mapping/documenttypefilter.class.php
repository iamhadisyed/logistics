...
class DocumentTypeFilter {
    ...
    /**
     * Get list of DocumentType items based on filter conditions
     *
    ...
    public function getPagingCount() {
        ...
        $sql = "SELECT count(*) as total FROM company_documents cd $where $sort ";
        t($sql, __METHOD__);
        return DocumentType::getTotalNumberOfDocumentTypeFromSql($sql);
    }
    ...
    public function getPagingList($columns = '*') {
        ...
        if ($this->order_by != "")
            $sort = "ORDER BY " . $this->order_by;
        $sql = "SELECT " . $columns . " FROM document_type dt  $where $sort LIMIT $this->pageOffset , $this->rowsPerPage";
        t($sql, __METHOD__);
        return DocumentType::getDocumentTypeListFromSql($sql);
    }
...
//      echo $sql;
    ...
    /**
     * Get count of DocumentType items based on filter conditions
     *
     * @return int
     */
