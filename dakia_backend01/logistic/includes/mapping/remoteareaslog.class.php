...
class RemoteareasLog extends DbAccess3 {
    ...
    public function __construct($mixedCreator = null) {
        ...
        //
        parent::__construct("remoteareas_log", 'id', $fieldList, $mixedCreator);
    }
     ...
     * @param string $sql
     */
    public static function getRemoteareasLogListFromSql($sql) {
     ...
     * @param string $sql
     */
    public static function getRemoteareasLogCountFromSql($sql) {
