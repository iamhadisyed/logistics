...
class CsvImportTemplateFilter {
    ...
    /**
     * Get list of CsvImportTemplate items based on filter conditions
     *
     * @return array[CsvImportTemplate]
     */
    public function getPagingCount() {
        ...
        $sql = "SELECT count(cit.id) as total FROM csv_import_template cit $checkJoin $where $sort ";
        t($sql, __METHOD__);
        return CsvImportTemplate::getTotalNumberOfCsvImportTemplateFromSql($sql);
    }
    ...
    public function getPagingList($columns = '*') {
       ...
       $sql = "SELECT " . $columns . " $joinColumnName FROM csv_import_template cit  $checkJoin  $where $sort LIMIT $this->pageOffset , $this->rowsPerPage";
        t($sql, __METHOD__);
        return CsvImportTemplate::getCsvImportTemplateListFromSql($sql);
    }
    ...
    /**
     * Get count of CsvImportTemplate items based on filter conditions
     *
     * @return int
     */
