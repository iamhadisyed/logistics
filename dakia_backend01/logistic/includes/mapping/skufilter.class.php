...
class SkuFilter
{
    ...
    public function getList($columns = '*', $debug = false)
    {
        ...
        return Sku::getSkuListFromSql($sql);
    }
    ...
    public function getCount($soft = true, $debug = false)
    {
        if ($soft) {
            ...
            $where = $this->getWhere();
            $sql = "SELECT COUNT(s.id) AS total FROM sku s $join $where";
            if ($debug) {
                echo $sql;
                die();
            }
        }
        return Sku::getTotalNumberOfSkuFromSql($sql);
    }
    ...
    public function delete($debug = false)
    {
        ...
        $where = $this->getWhere();
        $sql = "DELETE FROM sku  $join $where";
        if ($debug) {
            echo $sql;
            die();
        }
        return Sku::deleteSkuFromSql($sql);
    }
    ...
    public function update($debug = false){
        ...
        return Sku::updateSkuFromSql($sql);
    }
