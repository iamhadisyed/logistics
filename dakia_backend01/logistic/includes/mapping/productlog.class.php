...
class ProductLog extends DbAccess3 {
    ...
    public function __construct($mixedCreator = null) {
        ...
        //
        parent::__construct("product_log", 'id', $fieldList, $mixedCreator);
    }
     ...
     * @param string $sql
     */
    public static function getProductLogListFromSql($sql) {
     ...
     * @param string $sql
     */
    public static function getProductLogCountFromSql($sql) {
