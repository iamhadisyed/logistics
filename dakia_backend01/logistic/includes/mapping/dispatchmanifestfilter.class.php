...
class DispatchManifestFilter {
    ...
    /**
     * Get list of DispatchManifest items based on filter conditions
     *
     * @return array[DispatchManifest]
     */
    public function getPagingCount() {
        ...
        $sql = "SELECT count(dm.id) as total FROM dispatch_manifest dm $checkJoin $where $sort ";
        t($sql, __METHOD__);
        return DispatchManifest::getTotalNumberOfDispatchManifestFromSql($sql);
    }
    ...
    public function getPagingList($columns = '*') {
       ...
       $sql = "SELECT " . $columns . " $joinColumnName FROM dispatch_manifest dm  $checkJoin  $where $sort LIMIT $this->pageOffset , $this->rowsPerPage";
        t($sql, __METHOD__);
        return DispatchManifest::getDispatchManifestListFromSql($sql);
    }
    ...
    /**
     * Get count of DispatchManifest items based on filter conditions
     *
     * @return int
     */
