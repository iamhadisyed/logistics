...
class VehicleFilter
{
    ...
    public function getList($columns = '*', $debug = false)
    {
        ...
        return Vehicle::getVehicleFromSql($sql);
    }
    ...
    public function getCount($soft = true, $debug = false)
    {
        if ($soft) {
            ...
            $where = $this->getWhere();
            $sql = "SELECT COUNT(vhl.id) AS total FROM vehicle vhl $join $where";
            if ($debug) {
                echo $sql;
                die();
            }
        }
        return Vehicle::getTotalNumberOfVehiclesFromSql($sql);
    }
    ...
    public function delete($debug = false)
    {
        ...
        $where = $this->getWhere();
        $sql = "DELETE FROM vehicle  $join $where";
        if ($debug) {
            echo $sql;
            die();
        }
