...
class SkuBoxMappingFilter
{
    ...
    public function getList($columns = '*', $debug = false)
    {
        ...
        return SkuBoxMapping::getSkuBoxMappingListFromSql($sql);
    }
    ...
    public function getCount($soft = true, $debug = false)
    {
        if ($soft) {
            ...
            $where = $this->getWhere();
            $sql = "SELECT COUNT(so.id) AS total FROM sku_order so $join $where";
            if ($debug) {
                echo $sql;
                die();
            }
        }
        return SkuBoxMapping::getTotalNumberOfSkuBoxMappingFromSql($sql);
    }
    ...
    public function delete($debug = false)
    {
        ...
        $where = $this->getWhere();
        $sql = "DELETE FROM sku_order  $join $where";
        if ($debug) {
            echo $sql;
            die();
        }
        return SkuBoxMapping::deleteSkuBoxMappingFromSql($sql);
    }
    ...
    public function update($debug = false){
        ...
        return SkuBoxMapping::updateSkuBoxMappingFromSql($sql);
    }
