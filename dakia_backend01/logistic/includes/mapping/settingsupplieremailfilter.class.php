...
// get settings
class SettingSupplierEmailFilter {
    ...
    public function getList($columns = '*', $debug = false)
    {
        ...
        $sql = "SELECT SQL_CALC_FOUND_ROWS " . $columns . " FROM
                setting_supplier_email sse $join                
                $where $orderBy";
        ...
        return SettingSupplierEmail::getListFromSql($sql);
    }
    ...
    public function getCount($soft = true, $debug = false)
    {
        if ($soft) {
            ...
            $where = $this->getWhere();
            $sql = "SELECT COUNT(rd.id) AS total FROM setting_supplier_email sse $join $where";
            if ($debug) {
                echo $sql;
                die();
            }
        }
        return SettingSupplierEmail::getTotalNumberFromSql($sql);
    }
    ...
    public function delete($debug = false)
    {
        ...
        return SettingSupplierEmail::deleteDataFromSql($sql);
    }
    ...
    public function update($debug = false){
        ...
        return SettingSupplierEmail::updateDataFromSql($sql);
    }
