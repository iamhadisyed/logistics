...
class SkuOrderFilter
{
    ...
    public function getList($columns = '*', $debug = false)
    {
        ...
        return SkuOrder::getSkuOrderListFromSql($sql);
    }
    ...
    public function getCount($soft = true, $debug = false)
    {
        if ($soft) {
            ...
            $sql = "SELECT COUNT(distinct so.id) AS total FROM sku_order so $join $where $groupBy";
            if ($debug) {
                echo $sql;
                die();
            }
        }
        return SkuOrder::getTotalNumberOfSkuOrderFromSql($sql);
    }
    ...
    public function delete($debug = false)
    {
        ...
        return SkuOrder::deleteSkuOrderFromSql($sql);
    }
