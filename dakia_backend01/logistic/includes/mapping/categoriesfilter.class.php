...
class CategoriesFilter
{
    ...
    public function getCount($soft = true, $debug = false)
    {
        if ($soft) {
            ...
            $where = $this->getWhere();
            $sql = "SELECT COUNT(c.id) AS total FROM categories c $join $where";
            if ($debug) {
                echo $sql;
                die();
            }
        }
        return Categories::getTotalNumberOfCategoriesFromSql($sql);
    }
    ...
    public function delete($debug = false)
    {
        ...
        $where = $this->getWhere();
        $sql = "DELETE FROM categories  $join $where";
        if ($debug) {
            echo $sql;
            die();
        }
        return Categories::deleteCategoriesFromSql($sql);
    }
    ...
    public function update($debug = false){
        ...
        return Categories::updateCategoryFromSql($sql);
    }
