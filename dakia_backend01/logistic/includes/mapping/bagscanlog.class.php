...
class BagScanLog extends DbAccess3 {
    ...
    public function __construct($mixedCreator = null) {
        ...
        //
        parent::__construct("bag_scan_log", 'id', $fieldList, $mixedCreator);
    }
     ...
     * @param string $sql
     */
    public static function getBagScanLogListFromSql($sql) {
     ...
     * @param string $sql
     */
    public static function getBagScanLogCountFromSql($sql) {
