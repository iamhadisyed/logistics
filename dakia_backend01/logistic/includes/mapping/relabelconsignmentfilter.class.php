<?php 
/*
 * Relabel Consignment Filter
 *
 */

class RelabelConsignmentFilter {
    ...
    public function getList($columns = '*', $debug = false) {
        ...
        return RelabelConsignment::getRelabelConsignmentListFromSql($sql);
    }
    ...
    public function getCount($soft = true, $debug = false) {
        if ($soft) {
            ...
            $where = $this->getWhere();
            $sql = "SELECT COUNT(cr.id) AS total FROM consignment_relabel cr $join $where";
            if ($debug) {
                echo $sql;
                die();
            }
        }
        return RelabelConsignment::getTotalNumberOfRelabelConsignmentFromSql($sql);
    }
    ...
    public function delete($debug = false) {
        ...
        $where = $this->getWhere();
        $sql = "DELETE FROM consignment_relabel  $join $where";
        if ($debug) {
            echo $sql;
            die();
        }
        return RelabelConsignment::deleteRelabelConsignmentFromSql($sql);
    }
