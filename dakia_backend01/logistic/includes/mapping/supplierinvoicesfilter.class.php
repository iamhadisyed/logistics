...
class SupplierInvoicesFilter
{
    ...
    public function getList($columns = '*', $debug = false)
    {
        ...
        return SupplierInvoices::getSupplierInvoicesListFromSql($sql);
    }
    ...
    public function getCount($soft = true, $debug = false)
    {
        if ($soft) {
            ...
            $where = $this->getWhere();
            $sql = "SELECT COUNT(si.id) AS total FROM supplier_invoices si $join $where";
            if ($debug) {
                echo $sql;
                die();
            }
        }
        return SupplierInvoices::getTotalNumberOfSupplierInvoicesFromSql($sql);
    }
    ...
    public function delete($debug = false)
    {
        ...
        $where = $this->getWhere();
        $sql = "DELETE FROM supplier_invoices  $join $where";
        if ($debug) {
            echo $sql;
            die();
        }
        return SupplierInvoices::deleteSupplierInvoicesFromSql($sql);
    }
    ...
    public function update($debug = false){
        $where = $this->getWhere();
        $set = $this->getSet();
        $sql = "UPDATE supplier_invoices $set $where";
        if ($debug) {
            echo $sql;
            die();
        }
        return SupplierInvoices::updateSupplierInvoicesFromSql($sql);
    }
}
