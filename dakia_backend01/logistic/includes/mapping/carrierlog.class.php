...
class CarrierLog extends DbAccess3 {
    ...
    public function __construct($mixedCreator = null) {
        ...
        //
        parent::__construct("carrier_log", 'id', $fieldList, $mixedCreator);
    }
    ...
    public static function logArray(){
        $displayArray   =   array(
            ...
            'carrierdisplayname'=> 'Carrier Display Name',
            'status'                => 'Status',
        );
        return $displayArray;
    }
     ...
     * @param string $sql
     */
    public static function getCarrierLogListFromSql($sql) {
     ...
     * @param string $sql
     */
    public static function getCarrierLogCountFromSql($sql) {
