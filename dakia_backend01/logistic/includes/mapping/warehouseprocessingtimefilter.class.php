...
class WarehouseProcessingTimeFilter {
    ...
    public function getList() {
        ...
        $sql = "Select * from warehouse_processing_time $manifestjoin $where $sort LIMIT $this->pageOffset , $this->rowsPerPage";
        t($sql, __METHOD__);
        $WarehouseProcessingTime = new WarehouseProcessingTime();

        return WarehouseProcessingTime::getWarehouseProcessingTimeListFromSql($sql);
    }

    public function getOrderByList() {
        $sql = "SELECT * FROM warehouse_processing_time ORDER BY id DESC";
    ...
    public function getPagingCount() {
        ...
        $sql = "SELECT count(*) as total FROM warehouse_processing_time $where $sort ";

        t($sql, __METHOD__);

        return WarehouseProcessingTime::getTotalWarehouseProcessingTimeListFromSql($sql);
    }
    ...
    public function getPagingList() {
        ...
        echo $sql = "SELECT * FROM warehouse_processing_time $where $sort LIMIT $this->pageOffset , $this->rowsPerPage";
