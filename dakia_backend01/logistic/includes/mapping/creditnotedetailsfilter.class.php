...
class CreditNoteDetailsFilter {
    ...
    public function getList($columns = '*', $debug = false) {
        ...
        return CreditNoteDetails::getCreditNoteDetailsListFromSql($sql);
    }
    ...
    public function getCount($soft = true) {
        if ($soft) {
            ...
            $where = $this->getWhere();
            $sql = "SELECT COUNT(id) AS total FROM credit_note_details cnd $join $where";
        }
        return CreditNoteDetails::getTotalNumberOfCreditNoteDetailsFromSql($sql);
    }
    ...
    public function delete($debug = false) {
        ...
        $where = $this->getWhere();
        $sql = "DELETE FROM credit_note_details  $join $where";
        if ($debug) {
            echo $sql;
            die();
        }
        return CreditNoteDetails::deleteCreditNoteDetailsFromSql($sql);
    }
