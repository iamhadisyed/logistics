...
class Page extends BasePage {
    ...
    protected function init() {
        ...
        if(isset($this->form_vars["action"]) && $this->form_vars["action"] == "return"){
            //New logic
            $serviceIdArr = [];
            $parcelArrId = [];
            $labelArr = [];
                        ...
                        <div class="col-md-8">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                    $statusArr = array('return' => 'Return');
                                    echo Ddl::generateArrayDDL('status', $statusArr, "", '', ' class="form-control select2 select" rel="tooltip" data-original-title="Status" placeholder="Status"');
                                    ?>  <label>Status</label>
                                </div>
                            </div>
                            </div>
...
<!--                                    <div class="icheck-inline margin-top-10">-->
<!--                                        <label>-->
<!--                                            <input name="create_manifest" id="create_manifest" type="checkbox" class="icheck" data-checkbox="icheckbox_flat-blue" checked> Manifest-->
<!--                                        </label>-->
<!--                                    </div>-->
<!--                                </div>-->
<!--                            </div>-->
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="barcodelist" name="barcodelist" style=''  rows="10" cols="50" rel="tooltip" placeholder="Tracking/Hawb Numbers" data-original-title="Tracking/Hawb Numbers"></textarea>
                                    <label class="barcodelist">Tracking/Hawb Numbers</label>
                                </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group col-md-12">
                                <table  class="table table-striped table-bordered table-advance table-hover">
                                    <thead>
                                        <tr>
                                            <th style="color:red">Already return / Not found</th>
                                        </tr>
                                    </thead>
                                    <tbody id="not_found_tracking"> </tbody>
                                </table>
                            </div> 
                            <div class="form-group col-md-12">
                                <table class="table table-striped table-bordered table-advance table-hover">
                                    <thead>
                                        <tr>
                                            <th style="color:red">Duplicate Tracking Numbers</th>
                                        </tr>
                                    </thead>
                                    <tbody id="duplicate_tracking"></tbody>
                                </table>
                            </div>
                            <div class="form-group col-md-12">
                                <table class="table table-striped table-bordered table-advance table-hover">
                                    <thead>
                                    <tr>
                                        <th style="color:red">Return Consignment Label</th>
                                    </tr>
                                    </thead>
                                    <tbody id="return_con_label"></tbody>
                                </table>
                            </div>
                            <div class="form-group col-md-12">
                                <table class="table table-striped table-bordered table-advance table-hover">
                                    <thead>
                                    <tr>
                                        <th style="color:red">Return Manifest Label</th>
                                    </tr>
                                    </thead>
                                    <tbody id="return_manifest_label"></tbody>
                                </table>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row" style="text-align:center;">
                    <a id="btnSave"   href="#" class="btn btn-primary btn_save margin-top-10"><span></span>Save</a>
                </div>
            </div><!--portlet-body-->
        </div>
        <div class="portlet light">
