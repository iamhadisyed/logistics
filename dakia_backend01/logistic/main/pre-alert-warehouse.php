...
<?php /* ?><td id = "services<?php echo $id?>"><input type="checkbox" name='osx' value="Serv List" class='osx demo' onclick="servicePopup(<?php echo "'".$mawb."'" ?>)"></td><?php */ ?>    
                                ...
                                <td style="color:#000000 !important;">
                                    <input type='button'  id="<?php echo $id ?>" class="btn red btn-block margin-bottom-5" value='<? echo $etd;?>'  />
                                    <input type='hidden' id="etd<?php echo $id ?>" name="etd<?php echo $id ?>"  value="<?php echo $etd; ?>" />

                                    <input type='button' class="btn blue  btn-block margin-bottom-5"   id="<?php echo $id ?>" value='<? echo $eta;?>'  />
                                    <input type='hidden' id="eta<?php echo $id ?>" name="eta<?php echo $id ?>"  value="<?php echo $eta; ?>" />
                                </td>

                                <td id = "flight<?php echo $id ?>"><? echo $currentStatus;?></td>

                                <td style="color: #000000 !important;">
                                    <input type='button' class="btn btn-primary"   id="<?php echo $id ?>" value='<? echo $dateTime;?>' style='width:120px'  />
...
<?php /* ?> <td id="clear<?php echo $id?>"><? echo $cleared;?></td><?php */ ?>
                                ...
                                <!-- ,'".$cleared."' -->
                                <td>
                                    <a href="#" id="update<?php echo $id; ?>" title="Edit" onclick="UpdateAll(<?php echo "'".$id."','".$mawb."','".$flightNumber."','".$pieces."','".$weight."','".$comments."','".$preAccount."','".$currentStatus."','".$status."','".$shed."'" ?>)" ><span class="glyphicon glyphicon-pencil"></span></a>        
                                    <a href="#" id="delete<?php echo $id; ?>" title="Delete" onclick="DeleteRow(<?php echo "'".$id."'" ?>)" ><span class="glyphicon glyphicon-trash"></span></a>
                                    <a href="#" hidden="hidden" id="save<?php echo $id; ?>" title="Save" onclick="SaveAll(<?php echo "'".$id."'" ?>)" ><span class="glyphicon glyphicon-floppy-saved"></span></a>
                                    <a href="#" hidden="hidden" id="cancel<?php echo $id; ?>" title="Cancel" onclick="Cancel()" ><span class="glyphicon glyphicon-remove"></span></a>
