...
class Page extends BasePage
{
	...
	public function init()
	{
		...
		$this->setTitle("Upload Cost Prices");
		...
		else
		{
			$this->page_vars = util_getPostArray();
			 ...
			 $tariffUpdate->setToUpdateCostTariffs(true);
			 //
	...
	public function renderBody()
	{
        ...
        <div class="portlet box blue">
						...
						<div class="portlet-body">
							<div class="scroller" style="min-height:350px; max-height:600px" data-always-visible="1" data-rail-visible="1" data-rail-color="blue" data-handle-color="red">
								
                                
                                
              <div id="top-button-area">
				<a href="tariffs.php?service_id=<?php echo $p["service_id"] ?>">Tariffs</a>
			</div>                  
