...
require_once('../includes/autoload/MWSSubscriptionsService/Model/CreateSubscriptionInput.php');
require_once('../includes/autoload/MWSSubscriptionsService/Model/Subscription.php');
 ...
 ***********************************************************************/
 ...
 $subscriptionType = new MWSSubscriptionsService_Model_Subscription();
 $subscriptionType->setNotificationType('ReportProcessingFinished'); 
 ...
 $subscriptionType->setDestination($destination);
