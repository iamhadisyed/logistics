...
include_once ('../includes/autoload/MarketplaceWebServiceOrders/Client.php');
include_once ('../includes/autoload/MarketplaceWebServiceOrders/Model/ListOrderItemsRequest.php');
include_once ('../includes/autoload/MarketplaceWebServiceOrders/Model.php');
/************************************************************************
 ...
 ***********************************************************************/
 ...
 $request->setAmazonOrderId($_SESSION['amazon_order_id']);
                ...
                if ($response->isSetListOrderItemsResult()) { 
                    ...
                    if ($listOrderItemsResult->isSetOrderItems()) { 
                        ...
                        foreach ($memberList as $member) {
                            ...
                            if ($member->isSetASIN()) 
                            {
                                $MarketPlaceOrderDetails->setasin($member->getASIN());
                            }
                            if ($member->isSetSellerSKU()) 
                            {
                                $MarketPlaceOrderDetails->setsku($member->getSellerSKU());
                            }
                            if ($member->isSetTitle()) 
                            {
                                $MarketPlaceOrderDetails->settitle($member->getTitle());
                            }
                            if ($member->isSetQuantityShipped()) 
                            {
                                $MarketPlaceOrderDetails->setquantitypurchased($member->getQuantityShipped());
                            }
                            ...
                            if ($member->isSetItemPrice()) { 
                                ...
                                {
                                    $MarketPlaceOrderDetails->setitemprice($itemPrice->getAmount());
                                }
                            } 
