...
<style>
body {  }
.login { background: #fff !important; background: #fff url("images/login-homepagbg-spar.png") top center no-repeat !important; }
    ...
    <div class="row">
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            ...
            <div class="account-wall">
                ...
                <img class="profile-img" src="images/spar.png"
                    alt="">
                ...
                <button class="btn btn-lg btn-primary btn-block" type="submit" style="background: #ea1b2f; border-color: #ea1b2f">
                    Sign in</button>
