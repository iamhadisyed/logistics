        ...
        <?php errorList::getItem()->render(); ?>
                    <div class="row">
                        <div class="form-group col-md-6">
                            <img src="../images/tariff_1.png" width="1250px" />
                            <img src="../images/tariff_2.png" width="1250px" />
                            <img src="../images/tariff_3.png" width="1250px" />
                            <img src="../images/tariff_4.png" width="1250px" />
                        </div>	
                    </div>
                </div>
