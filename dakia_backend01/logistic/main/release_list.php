    ...
    public function renderHead() {
        ...
        <!--
            $(document).ready(function () {
                ...
                $("#from_date").datepicker({dateFormat: 'dd/mm/yy', buttonImage: '../images/calendar.gif', buttonImageOnly: true});
                //
                $("#to_date").datepicker({dateFormat: 'dd/mm/yy', buttonImage: '../images/calendar.gif', buttonImageOnly: true});
    ...
    public function renderBody() {
        ...
        <div class="main_formpage">
            ...
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"> <span class="glyphicon glyphicon-edit"></span>
        ...
        <?php $this->carrierDropDown(@$carrier); ?>
                    ...
                    <div class="row" style="text-align:center;">    
                        ...
                        <a id="btnSave" href="#" name="btnSave" class="btn btn-primary btn_save"><span></span>Generate</a>
                        <br/>
                    </div>
                </div>
            </div>
