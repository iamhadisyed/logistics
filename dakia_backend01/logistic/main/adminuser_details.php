                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="password" name="password" type="password"  class="form-control" value="" title="The Pasword must be at least one upper case english letter,at least one lower case english letter,at least one special character and minimum 8 in length." rel="tooltip" autocomplete="off"/>
