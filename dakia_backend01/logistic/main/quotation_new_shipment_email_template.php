                                                                                                ...
                                                                                                <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0px;"
                                                                                                    align="left"><a
                                                                                                            ...
                                                                                                            target="_blank"><img
                                                                                                                ...
                                                                                                                width="278"
                                                                                                                height="51"
                                                                                                                style="border-width:0; max-width:200px;height:auto; display:block"
                                                                                                                align="left"/></a>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                                                    ...
                                                                                                    <table class="contents"
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td width="57%"
                                                                                                                align="right"
                                                                                                                valign="top">
                                                                                                                <!-- <img src="images/eye.jpg" width="25" height="9" style="border-width:0; max-width:25px;height:auto; display:block; max-height:9px; padding-top:4px; padding-left:10px" alt=""/> --></td>
                                                                                                            <td width="43%"
                                                                                                                align="right"
                                                                                                                valign="top">
                                                                                                                <font style="font-size:11px; text-decoration:none; color:#474b53; font-family: Verdana, Geneva, sans-serif; text-align:left; line-height:36px; ">Your
                                                                                                                    package
                                                                                                                    is
                                                                                                                    our
                                                                                                                    pride</font>
                                ...
                                <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%"
                                    ...
                                    <tr>
                                        <td align="left" style="padding:0px 40px 40px 40px"><p
                                                    style="color:#262626; font-size:18px; text-align:left; font-family: Verdana, Geneva, sans-serif">
                                                Dear [name]</p>
