...
class Page extends BasePage {
    ...
    public function renderBody() {
        ...
        $numrows = $locationFilter->getPagingCount();
        ...
        $this->report_data = $locationFilter->getColumnList("id, name, warehouseid, active");
        ...
        <div class="row">
            <div class="col-md-12"> 
                <h3 class="page-title">View Locations</h3>
            </div>
        </div>
                        ...
                        <div class="col-md-6">                       
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <input type="text" name="name" id="name" size="100" value="<?php echo @$this->name; ?>" class="form-control" placeholder="Location Name" />
                                </div>
                            </div>
                    ...
                    <div class="table-scrollable">
                        <div class="table-bordered">                        
                            <table class="table table-striped table-bordered table-advance table-hover">
                                <thead>                                
                                    <tr>
                                        <th class="red-back">Name</th>
                                        <th class="red-back">Hub</th>
                                        <th class="red-back">Active</th>
        ...
        if (count($this->report_data) > 0) {
            foreach ($this->report_data as $report_data) {
                ?>        
                                            <tr>                                            
                                                <td><?php echo $report_data->getName(); ?></td>
                                                <td><?php $warehouse = new Warehouse($report_data->getWarehouseId());
                echo $warehouse->getWarehouseName();
                ?></td>
                                                <td><?php echo $report_data->getActive(); ?></td>
                                                <td><?php echo "<a target='_blank' href='addlocation.php?id=" . $report_data->getId() .
                            "'>Edit</a>";
                ?></td>
                                            </tr>
                <?php
    ...
    public function init() {
        ...
        $this->setTitle("Admin - View Warehouse Locations");
    }
