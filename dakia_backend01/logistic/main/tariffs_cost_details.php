...
class Page extends BasePage {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data == 'SUCCESS')
                        {
                            ...
                            setTimeout(function () {
                                window.location = 'tariffs_cost_details.php?service_id=' + service_id + '&collection_rateband_id=' + collection_rateband_id + '&destination_rateband_id=' + destination_rateband_id + '&collection_postcode_group_id=' + collection_postcode_group_id + '&destination_postcode_group_id=' + destination_postcode_group_id + '&tariff_name=' + customerId;
    ...
    private function buildPostcodeGroupDropDown($dropdown_name, $selected_postcode_group_id) {
        ...
        ?>
        <select name="<?php echo $dropdown_name ?>" id="<?php echo $dropdown_name; ?>">
    ...
    public function renderBody() {
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-gift"></i>Tariffs Details
                </div>
                <div class="tools">
                    ...
                    <div id="tariff_details">
                        <div style="width:100%">
                            ...
                            if (trim($_REQUEST['tariff_name']) != '') {
                                ?><a class="btn btn-primary pull-right" href="tariffs_cost.php?service_id=<?php
                            ...
                            <table id="tbl_tariffs" class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr class="textb" id="tbl_header2">
                                        ...
                                        <th colspan="2" class="bg-blue Cost Prices title_white"><center>
                                    Cost Prices
                                </center></th>
                                ...
                                <tr>
                                    <th class="cost">Tariff (CHRG)</th>
                                    <th class="cost">Unit Price (ITMCHR)</th>
                                ...
                                <tbody>
                                    ...
                                    if (count($this->tariffs) > 0) {
                                        foreach ($this->tariffs as $tariff) {
                                            ...
                                            $tarrifName = $tariff->getTariffName();
                                            ...
                                            <tr class="textb">
                                                ...
                                                <td><input class="form-control" id="tbl_ex_tariff_<?php echo $tariff->getId() ?>" name="ex_tariff[]" type="text" value="<?php echo $tariff->getTariffCost(); ?>"></td>
                                                <td><input class="form-control" id="tbl_ex_unit_price_<?php echo $tariff->getId() ?>" name="ex_unit_price[]" type="text" value="<?php echo $tariff->getUnitCost(); ?>"></td>
                                                <td><input class="form-control" id="tbl_customer_id_<?php echo $tariff->getId() ?>" name="unit_customer_id[]" type="text" value="<?php echo $tariff->getTariffName(); ?>"></td>
    ...
    public function init() {
        ...
        if (util_request("action") == "confirmed_delete") {
            ...
            if (trim($tariff_name) != '') {
                ...
                $TarDelObj->setTariffName($tariff_name);
                $TarDelObj->expunge();
            }
            //
        ...
        if (isset($_POST['btn_save'])) {
            ...
            foreach ($this->weight as $key => $val) {
                ...
                if ($val > 0) {
                    ...
                    $this->tariff_array[$arrayCount]['tariff_name'] = $this->unit_customer_id[$key];
        ...
        if (isset($_POST['btn_save'])) {
            ...
            for ($key = 0; $key < sizeof($this->tariff_array); $key++) {
                ...
                if (sizeof($this->tariff_array) > $key) {
                    ...
                    $TarSavObj->setTariffName($this->tariff_array[$key]['tariff_name']);
                }
