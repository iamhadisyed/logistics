...
$('table.paginated').each(function() {
 ...
 <div class="portlet box blue">
            <div class="portlet-title">
            	<div class="caption"> <span class="glyphicon glyphicon-cloud-upload"></span>
				 Upload Pre Alert Files	</div>
            ...
            <?php 
				if(trim(errorList::getItem()->render()))
					echo   '<div class="alert alert-success">'.errorList::getItem()->render().'</div>';
			?>
            <div class="alert alert-error"><?php errorList::getItem()->render(); ?></div>
            <?php 
				if(trim($this->bob) != '')
					echo   '<div class="alert alert-success">'.$this->bob.'</div>';
			?>
             
         	<div class="col-md-12">
            	<p>Here you can upload your pre-alert files and email them to the Warehouse team.</p>
            </div>
            <div class="col-md-4">
             <? if(Sessionmanager::getUser()->getUserType() != 'warehouse') 
				{
...
<table id='consignment_list'  class="table table-striped table-bordered table-advance table-hover">	
			<!-- table head -->
			 <thead>
							<tr>
								<th class="red-back">Filename</th>
								<th class="red-back">File Size</th>
                                <th class="red-back">Date/Time Created</th>
								<th class="red-back">Options</th>
...
<!--<table  class="consignment_list_tbl">
			...
			<!-- table head -->
			 <thead>
							<tr>
								<th align="center" class="red-back">Folder</th>
								<th align="center" class="red-back">Options</th>
