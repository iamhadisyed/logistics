...
class Page extends BasePage {
    ...
    protected function init() {
        ...
        $this->setTitle("Top Services List");
        if ($this->table_msg == "")
            $this->table_msg = "Top Service List";
        ...
        $this->services_data = $consignmentFilteter->getDashboardTopServices("50000");
    }
    ...
    protected function renderBody() {
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="../main/top_services_list.php">Top Services</a></li>
            <li><a href="#">List</a></li>
        </ul>
                    ...
                    <div id='table_container'  class="main_grid2">
                        <div class="table-scrollable">
                            <table id='consignment_list' class="table table-striped table-bordered table-advance table-hover" >
                                ...
                                <tbody>
                                <?php
                                foreach ($this->services_data as $services_list) {
                                    ?>
                                    <tr>
                                        <td><?php echo $services_list->getServiceType(); ?></td>
                                        <td><?php echo $services_list->getId(); ?></td>
                                    </tr>
                                <?php } ?>
                                </tbody>
                            </table>
