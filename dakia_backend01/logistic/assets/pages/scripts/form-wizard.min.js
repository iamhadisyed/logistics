...
var current = index + 1;
// set wizard title
$('.step-title', $('#form_wizard_{!!$carrierServices->id !!}')).text('Step ' + (index + 1) + ' of ' + total);
// set done steps
jQuery('li', $('#form_wizard_{!!$carrierServices->id !!}')).removeClass("done");
...
if (current == 1) {
    $('#form_wizard_{!!$carrierServices->id !!}').find('.button-previous').hide();
} else {
    $('#form_wizard_{!!$carrierServices->id !!}').find('.button-previous').show();
}
if (current >= total) {
    $('#form_wizard_{!!$carrierServices->id !!}').find('.button-next').hide();
    $('#form_wizard_{!!$carrierServices->id !!}').find('.button-submit').show();
//                        displayConfirm();
} else {
    $('#form_wizard_{!!$carrierServices->id !!}').find('.button-next').show();
    $('#form_wizard_{!!$carrierServices->id !!}').find('.button-submit').hide();
}
