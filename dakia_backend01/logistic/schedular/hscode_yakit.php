...
$mysqlQueryConnection = DbAccess3::connect(SETTING_DB_SERVER, SETTING_DB_USER, SETTING_DB_PASSWORD, SETTING_DB_DATABASE);
$queryEbayDescription = "SELECT * FROM ebay_description WHERE hscode is NULL ORDER BY id desc limit 500";
$recordSet = DbAccess3::runQueryWithError($queryEbayDescription);
if(mysqli_num_rows($recordSet)>0){
    while ($ebayDescription = mysqli_fetch_assoc($recordSet)) {
        print_r($ebayDescription);
        die;
    }
}
