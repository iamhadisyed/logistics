...
include_classes([
    ...
    'huxloehermestrackingstatus.class'
    ]);
...
$serviceObjArr = $servicesFilter->getCarrierFromCode("STHUXSTND");
...
if(count($consignmentObj) > 0){
    foreach($consignmentObj as $consignment){
        ...
        $huxloeHermes = new HuxloeHermes();
        $huxloeHermes->tracking($trackingNo);
