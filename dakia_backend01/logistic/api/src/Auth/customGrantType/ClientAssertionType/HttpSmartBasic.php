 ...
 */
class HttpSmartBasic implements SmartAssertionTypeInterface
{
    private $clientData;
    ...
    public function validateRequest(RequestInterface $request, ResponseInterface $response)
    {
        ...
        } elseif ($this->storage->checkSmartCredentials($clientData['client_id'], $clientData['client_secret']) === false) {
