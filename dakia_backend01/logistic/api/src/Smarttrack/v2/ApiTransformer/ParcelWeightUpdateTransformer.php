 ...
 */
class ParcelWeightUpdateTransformer  extends SmartTransformer {
    public function transform($shipRes)
    {
        ...
        if(isset($shipRes['STATUS']) && $shipRes['STATUS'] == 'SUCCESS'){
            ...
            $message = "Shipment weight update successfully";
            return $this->sr->success(200,$message,$messageCon,$warnings);
        }
