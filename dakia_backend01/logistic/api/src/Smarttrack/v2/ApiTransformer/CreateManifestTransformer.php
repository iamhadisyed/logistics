...
class CreateManifestTransformer extends SmartTransformer {
    ...
    public function transform($shipRes) {
        ...
        if (isset($shipRes['STATUS']) && $shipRes['STATUS'] == 'SUCCESS') {
            ...
            return $this->sr->success(200, $message, $shipRes['DATA'], $warnings);
        }
